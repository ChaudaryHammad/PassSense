const generateEmailTemplate = (type, data) => {
    switch (type) {
        case 'signup':
            return `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                    <h2 style="background-color: #f2f2f2; padding: 10px;">Welcome to PassSense </h2>
                    <p>Hi ${data.name},</p>
                    ...
                    <footer style="text-align: center; font-size: 12px; color: #aaa;">
                        <p>&copy; ${new Date().getFullYear()} PassSense. All rights reserved.</p>
                        <p>hammad.node@gmail.com</p>
                    </footer>
                </div>
            `;
        case 'Welcome':
            ...
            case 'Reset':
                return `
                    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                        <h2 style="background-color: #f2f2f2; padding: 10px;">Password reset request (PassSense)</h2>
                        <p>Hi ${data.name},</p>
        ...
        case "Reset Success":
            return `
            <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <h2 style="background-color: #f2f2f2; padding: 10px;">Password reset Success(PassSense)</h2>
                <p>Hi ${data.name},</p>
