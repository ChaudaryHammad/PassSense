...
<h1 className=' text-[24px]  lg:text-[46px]'><span className='underline decoration-[#6dfd30]'>Instant </span>Reading and Verification of MRZ</h1>
<p>Regula MRZ reading technology automatically reads the MRZ lines, dividing them into separate fields, and validates MRZs with all the data they contain in accordance with ICAO 9303 and ISO 18013 standards.</p>
